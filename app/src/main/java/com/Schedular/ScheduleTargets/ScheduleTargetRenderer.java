...
import com.Schedular.Vuforia.Utilities.CubeShaders;
import com.Schedular.Vuforia.Utilities.LoadingDialogHandler;
import com.Schedular.Vuforia.Utilities.SampleUtils;
import com.Schedular.Vuforia.Utilities.Teapot;
import com.Schedular.Vuforia.Utilities.Texture;


// The renderer class for the ScheduleTargets sample.
public class ScheduleTargetRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl {
    private static final String LOGTAG = "ScheduleTargetRenderer";
    private static final float OBJECT_SCALE_FLOAT = 0.003f;
    private SampleApplicationSession vuforiaAppSession;
    private ScheduleTargets mActivity;
    ...
    public ScheduleTargetRenderer(ScheduleTargets activity, SampleApplicationSession session) {
        mActivity = activity;
