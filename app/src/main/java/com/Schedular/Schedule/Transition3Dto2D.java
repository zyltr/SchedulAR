...
public class Transition3Dto2D
{
    ...
    public Transition3Dto2D(int screenWidth, int screenHeight, boolean isPortraitMode, float dpiSIndicator, float scaleFactor, Plane p)
    {
    ...
    public void updateScreenPoperties(int screenWidth, int screenHeight, boolean isPortraitMode)
    {
        ...
        int texture1)
    {
        ...
        Matrix44F modelViewMatrixVuforia = Tool.convertPose2GLMatrix(targetPose);
        float[] modelViewMatrix = modelViewMatrixVuforia.getData();
        float[] finalPositionMatrix = getFinalPositionMatrix();
        
        Matrix.scaleM(modelViewMatrix, 0, 0.430f * scaleFactor, 0.430f * scaleFactor, 1.0f);
        ...
        GLES20.glUniformMatrix4fv(mvpMatrixHandle, 1, false, modelViewProjectionCurrent, 0);
